...
module.exports = app => {
  ...
  app.beforeStart(async () => {
    app.liteMenu = await client.query('select sm.id menu_id, sm.parent_id menu_parent_id, sm.path menu_path, sp.id permission_id from sys_menu sm left join sys_permission sp on sp.permission = sm.id and sp.type="0";');
